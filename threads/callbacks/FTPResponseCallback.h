...
#ifndef _SYSTEM2_FTP_RESPONSE_CALLBACK_H_
...
public:
    ...
    FTPResponseCallback(FTPRequest* ftpRequest, CURL* curl, std::string content, size_t contentLength);
