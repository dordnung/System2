...
cd "$SYSTEM2_DIR" || exit
make SMSDK="$BUILD_DIR/sourcemod-${SMBRANCH}" OPENSSL="$BUILD_DIR/openssl-1.1.1g" ZLIB="$BUILD_DIR/zlib-1.2.11" IDN="$BUILD_DIR/libidn2-2.3.0" CURL="$BUILD_DIR/curl-7.71.1"